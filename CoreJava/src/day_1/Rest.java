...
class Rest{
	public static void main(String[] args){
		...
		switch (option) {
			case 1: bill_value += qty*100; 
			break;
			case 2: bill_value += qty*50; 
			break;
			case 3: bill_value += qty*150; 
			break;
			case 4: bill_value += qty*200; 
			break;
			case 5: bill_value += qty*80; 
			break;
			case 6: bill_value += qty*400; 
			break;
			case 7: bill_value += qty*700; 
			break;
			case 8: bill_value += qty*380; 
			break;
			case 9: bill_value += qty*20; 
			break;
