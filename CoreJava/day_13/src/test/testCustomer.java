...
class testCustomer {
    public static void main(String[] args) {
        Map<String,Customer1> customers = new HashMap<>();
            ...
            while (!flag) {
                ...
                switch (option) {
                    case 1:
                        ...
                        Customer1 cv = CustomerValidation.validateUser(firstName, lastName, email, password, dateOfBirth,
                    ...
                    case 2:
                        ...
                        if (Customer1.signIn(email1, password1, customers)) {
                    ...
                    case 3:
                        ...
                        if (Customer1.signIn(email11, password11, customers)) {
                            System.out.println("Valid User\n Enter new Password");
                            Customer1.changePassword(email11, sc.next(), customers);
                    ...
                    case 4:
                        ...
                        if(Customer1.unSubscribe(email3, customers)) {
